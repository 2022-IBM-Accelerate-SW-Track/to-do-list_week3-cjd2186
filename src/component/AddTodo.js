...
class AddTodo extends Component {
  ...
  // The handleDueDate function updates the react state with the datepicker to set the value of the user's due date.
  // "event" is the defined action a user takes. In this case, the event is triggered when the user picks a date in the datepicker
  handleDueDate = (event) => {
    this.setState({
